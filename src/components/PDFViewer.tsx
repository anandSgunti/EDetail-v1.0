      ...
      if (window.AdobeDC && viewerRef.current) {
        ...
        reader.onloadend = (e) => {
          ...
          window.adobeDCView.previewFile(
            ...
            },{enableSearchAPIs: true, showAnnotationTools: false, showBookmarks: false, showZoomControl: false, defaultViewMode: " SINGLE_PAGE",embedMode: "FULL_WINDOW", showAnnotationTools: false, showFullScreenViewButton: true});
